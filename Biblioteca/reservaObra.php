      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="consultarArcevo.ph">Consultar Acervo<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
        ...
        <div class="container">
          <h2 class="display-4">CONSULTAR ACERVO</h2>
			<br><br>
               ...
               <form method="POST" action="buscaAcervo.php">
                <div class="form-row">
